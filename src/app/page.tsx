  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="flex items-center justify-between px-8 py-5">
        <h1 className="text-xl font-display font-bold">Paideia</h1>
        <Link
          href="/login"
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 pb-20">
        ...
        <p className="text-lg text-text-secondary mt-6 max-w-lg leading-relaxed">
          Upload your coursework. Paideia reads it, then guides you through problems step-by-step — never giving answers, always helping you find them.
        </p>
      ...
      {/* Features */}
      <section className="border-t border-bg-elevated py-20 px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-text-secondary leading-relaxed">
                Drop in your homework, study guides, or practice sets. Paideia extracts and understands the content.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-sm text-text-secondary leading-relaxed">
                Paideia asks guiding questions, gives you multiple-choice checkpoints, and walks you through step-by-step.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-sm text-text-secondary leading-relaxed">
                Build real understanding — not just answers. The Socratic method helps knowledge stick.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="border-t border-bg-elevated py-8 px-6 text-center">

...
// Persistence helpers (`detectAndPersistStructureFor*`) live in
// `./material-structure-persist.ts` — kept out of this module so
// scripts + tests that only need detection logic don't transitively
